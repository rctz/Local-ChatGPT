"""
Django settings for local_gpt_server project.
...
SECRET_KEY = "django-insecure-i2p2i6u6z67nbs7sjfpn$faq9g@@tt7$et&fhxciyn#=50b@m7"
...
CACHES = {
    "default": {
        ...
        "LOCATION": ServerConfig.build_redis_url(),  # Adjust the URL as needed.
    }
}
...
SESSION_COOKIE_AGE = ServerConfig.build_session_time()
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "local_gpt_server", "static"),
]
